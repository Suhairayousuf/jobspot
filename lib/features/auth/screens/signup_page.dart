    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
         ...
         Column(
           children: [
             Text('Create an Account',style: GoogleFonts.notoSans(color:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text('User Name',style: GoogleFonts.notoSans(color:
                Colors.black,fontSize:
          ...
          Column(
            children: [
              Container(width: width*0.7,
                ...
                height: width*0.15 ,
                child: Center(
                  child: Text('SIGN UP',style: GoogleFonts.notoSans(color:
              ...
              Row(
                ...
                children: [
                  Text('You already have an account?',style: GoogleFonts.notoSans(color:
                  Colors.black,fontSize:
                  width*0.03,fontWeight: FontWeight.w400),),
                  InkWell(
                    onTap: (){
                    ...
                    child: Text('Signin',style: GoogleFonts.notoSans(color:
                    Colors.red,fontSize:
